...
\begin{figure}[htb]
  \begin{minipage}[t]{0.5\textwidth}
    ...
    \includegraphics[scale=1]{BDX6530_dessus}
  ...
  \begin{minipage}[t]{0.5\textwidth}
    ...
    \includegraphics[scale=1]{BDX6530_lame}
  ...
  \begin{minipage}[t]{0.5\textwidth}
    ...
    \includegraphics[scale=1]{BDX6530_coupe}
...
\begin{figure}[htb]
  \fakeimg{État de surface (fig 40)}
...
\begin{table}
  \begin{saotab}
      \saolgna{Glaçure}{594.39}{8.88}
              {6.505}{0.338}{0.335}
              {30.652}{4.036}{2.934} &
      \saolgnb{orange très foncé}{Orange}{585}{600}
              {\footcite{Kelly_1976}}
    \tabularnewline
      \saolgna{Terre cuite}{579.70}{23.30}
              {47.348}{0.359}{0.366}
              {74.412}{3.957}{18.143} &
...
\begin{figure}[htb]
  ...
  \begin{minipage}[t]{0.37\paperwidth}
    ...
    \end{plotLab}
    \subcaption{espace trichromatique \Lab.}
  \end{minipage}%
  \caption[\bdx{6530}\ -- Espaces trichromatiques]
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\begin{figure}[htb]
  \includegraphics[width=\textwidth]{BDX6530_DX}
