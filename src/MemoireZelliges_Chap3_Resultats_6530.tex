...
\begin{figure}[htb]
  ...
  \RaggedLeft
  \begin{sidecaption}[%
    \bdx{6530}\ -- Observation de la texture au \MEB, 
    ...
    \includegraphics[width=\imgwidth]{PaM_BDX6530_ERD}%
  \end{sidecaption}
\end{figure}
...
\begin{figure}[htb]
  \includegraphics[width=\textwidth]{PaM_BDX6530_carto_cx}%
...
\begin{figure}[htb]
  ...
  \RaggedLeft
  \begin{sidecaption}[%
    \bdx{6530}\ -- Image en mode \ERD, cristaux aciculaires 
    ...
    \includegraphics[width=\imgwidth]{PaM_BDX6530_ERD_cx}%
  \end{sidecaption}
\end{figure}
