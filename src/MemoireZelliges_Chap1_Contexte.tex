...
des \sieclelist{9}{11} (Tunisie et Algérie modernes), des 
...
céramique Aghlabides et abbassides (\sieclerange{8}{9}). Ces 
...
\sieclerange{12}{13}. On peut en voir des exemples 
...
aux \sieclerange{14}{15}, que l'art des zelliges atteint son 
...
à partir du \siecle{17}. Ces périodes n'ont, en effet, quasiment
...
au \siecle{14}. On parle notamment d'un artisan nommé \emph{Qaçim
...
Les deux cuissons sont menées dans le même four \farina). 
...
\zillig découpées devant derrière sur le sol selon 
...
\incise{commentaires ajoutés au Livre Saint au \siecle{9}} 
...
aux \sieclerange{13}{14} mais l'interdiction est totale dans 
...
\begin{figure}[htb]
  \begin{minipage}[b]{0.45\textwidth}
    \centerfloat
    \includegraphics[height=6.5cm]{symetrie_motif_base_ori}
  ...
  \begin{minipage}[b]{0.45\textwidth}
    \centerfloat
    \includegraphics[height=6.5cm]{symetrie_motif_dessin}
  ...
  \begin{minipage}[b]{0.45\textwidth}
    \centerfloat
    \includegraphics[height=6.5cm]{symetrie_motif_complet}
