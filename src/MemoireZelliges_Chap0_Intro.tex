...
\footnote{\frquote{Archéomatériaux composites de 
 l'architecture en Méditerranée : verre-terre cuite -- altération et 
 recréation}} 
% (archéomatériaux composites de 
% l'architecture en Méditerranée : verre-terre cuite -- altération et 
% recréation) 
...
\begin{itemize}
  \item échantillons du Palais de Chellah (Rabat), 
        \siecle{14} (\gens[Jennifer]{Delmas}, maîtrise) ;
  \item échantillons de la medersa Filalia (Meknès), 
        \siecle{14} (\gens[Richard]{Cheret}, DESS) ;
  \item échantillons de la medersa Bu'Inaniya (Meknès), 
        \siecle{14} (\gens[Yannick]{Melin}, maîtrise et 
        \gens[Richard]{Cheret}, DESS).
\end{itemize}
