...
Il s'agit d'un zellige provenant du \PaM, \siecle{xvii}, (Meknès, 
...
\begin{figure}[htb]
  \begin{minipage}[t]{0.5\textwidth}
    ...
    \includegraphics[scale=1]{BDX6529_dessus}
  ...
  \begin{minipage}[t]{0.5\textwidth}
    ...
    \includegraphics[scale=1]{BDX6529_lame}
  ...
  \begin{minipage}[t]{0.5\textwidth}
    ...
    \includegraphics[scale=1]{BDX6529_coupe}
...
\begin{figure}[htb]
  ...
  \caption{\legendeB 
           ...
           \zone{\sim4.3x3.2}{\mm}). Elle contient des 
...
\begin{figure}[htb]
  ...
  \end{plotspectre}
  \caption{\legendeB 
           Spectres d'\AO en mode réflexion diffuse de la glaçure et de la terre cuite. La coloration de la glaçure est due au \ce{Co^2+} mis en évidence par les trois bandes d'absorption à \SIlist{525;600;660}{\nm}.}
  \label{spectre:6529}
\end{figure}
...
Nous avons donc utilisé un montage spectrophotomètre/microscope optique (Gr=40) permettent de focaliser le faisceau pour analyser une zone saine de la glaçure. Le spectre obtenu présente, lui aussi, les trois bandes d'absorption caractéristiques du \ce{Co^2+}. Les résultats de \CHRO sont consignés dans le \tref{saotab:6529} et la \fref{colorfig:6529} en donne les représentations graphiques. La longueur d'onde dominante est cette fois de \SI{482.54}{\nm}, elle correspond au domaine du bleu verdâtre \autocite{Kelly_1976}. La pureté d'excitation \SI{3.71}{\percent} est celle d'une couleur très peu saturée, la réflectance $Y$ (\num{27.839}) indique une couleur assez foncée.

\begin{table}
  \begin{saotab}[Appareillage]
      \saolgna{Spectro\-photo\-mètre}{551.45}{3.81}
              {27.953}{0.313}{0.343}
              {59.847}{-4.345}{3.382} &
      \saolgnb{vert jaunâtre foncé}{Vert-Jaune}{530}{560}{}
    \tabularnewline
      \saolgna{Spectro\-photo\-mètre + microscope optique}
              {482.54}{3.71}
              {27.839}{0.304}{0.323}
              {59.743}{-1.006}{-2.601} &
      \saolgnb{bleu verdâtre foncé}{Bleu-verdâtre}{482}{487}
              {\footnotemark{}}
    \tabularnewline
  \end{saotab}
  \caption{\legendeB 
...
\begin{figure}[htb]
  ...
  \end{minipage}%
  \caption[\bdx{6529}\ -- Espaces \trichro s]
...
Une \carto de \RX (\fref{MEB:6529_carto_tcgla}) a permis de montrer que ces cristaux sont des quartz (\ce{SiO2}). Ils sont responsables des luminescences mauves détectées en \CL.
...
Une \carto de la terre cuite (\fref{MEB:6529_carto_tc}) a permis de mettre en évidence la présence de cristaux de quartz et de feldspaths potassiques. Ces derniers sont à l'origine des luminescences ponctuelles bleues observées en \CL. Les luminescences rouges détectées en \CL peuvent être corrélées avec la présence dans la terre cuite de calcium, probablement sous forme de calcite (\ce{CaCO3}).
...
Sa coloration ocre rose est due au \ce{Fe^3+} en atmosphère de cuisson 
oxydante \autocite{Echallier_1984}.

\subsection{Composition \cristallo}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Le principal composé cristallisé mis en évidence par \DX sur poudre (\fref{DRX:6529}) est le quartz (\ce{SiO2}). On relève également la présence, à des teneurs plus faibles, de calcite (\ce{CaCO3}) pouvant correspondre aux émissions rouges détectées en \CL, d'albite (\ce{NaAlSi3O8}), de diopside alumineux (\ce{Ca(Mg{,}Al)(Si{,}Al)2O6}) et de gehlénite (\ce{Ca2Al2SiO7}). Ces deux derniers cristaux peuvent être responsables des émissions bleues détectées en \CL.
...
\begin{figure}[htb]
  \includegraphics[width=\textwidth]{BDX6529_DX}
...
Cet échantillon est donc une pièce de céramique portant une glaçure plombifère dont la coloration bleue est due au \ce{Co^2+} en atmosphère de cuisson oxydante et légèrement opacifiée à l'étain pour rendre la couleur plus veloutée et masquer la terre cuite rougeâtre.

Son support de terre cuite est de type calcique. Sa coloration rougeâtre est due à la présence de \ce{Fe^3+} en atmosphère de cuisson oxydante.
