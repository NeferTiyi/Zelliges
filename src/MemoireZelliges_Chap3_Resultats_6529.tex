...
\begin{figure}[htb]
  ...
  \begin{minipage}[t]{0.37\paperwidth}
    ...
    \end{plotLab}
    \subcaption{espace trichromatique \Lab. Le point représentatif de 
                la couleur de la glaçure est dans le quart vert-bleu.}
  \end{minipage}%
  \caption[\bdx{6529}\ -- Espaces trichromatiques]
...
plombifère dont la coloration bleue est due au \ce{Co^2+} en 
...
rougeâtre est due à la présence de \ce{Fe^3+} en atmosphère de cuisson 
oxydante.
