...
\begin{figure}[p]
  \begin{minipage}[t]{0.48\textwidth}
    \centerfloat
    \includegraphics[width=\textwidth]{PaM_BDX6528_LN}%
...
\begin{figure}[p]
  ...
  \RaggedLeft
  \begin{sidecaption}[%
    \bdx{6528}\ -- Observation de la texture au \MEB, 
    ...
    \includegraphics[width=\imgwidth]{PaM_BDX6528_ERD}%
  \end{sidecaption}
\end{figure}
...
% \begin{figure}[htb]
\begin{figure}[p]
  \includegraphics[width=\textwidth]{PaM_BDX6528_carto}%
...
% \begin{figure}[htb]
\begin{figure}[p]
  \includegraphics[width=\textwidth]{PaM_BDX6528_carto_tc}%
  \caption[\bdx{6528}\ -- Observation de la texture au \MEB, 
