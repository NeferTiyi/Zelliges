...
proviennent du \PaM, daté du \siecle{17} et situé dans Meknès, la 
Versailles du Maroc.
...
\begin{figure}[hbt]
  \includegraphics[width=0.50\textwidth]{maroc}
...
% % \begin{figure}[htb]
% \begin{figure}[p]
%   % \includegraphics[height=8cm]{palais}
...
\begin{figure}[p]
  \includegraphics[height=9.5cm]{palais2}
  \subcaption{Plan d'ensemble \autocite{Barrucand_1976} 
              \label{fig:palais}}

  \bigskip

  \includegraphics[height=9cm]{palais_etage2}
  \subcaption{Plan de l'étage. En rouge : point de prélèvement 
              (réalisation : \gens[A.]{Benmlih} et \gens[M.]{Haddad})
              \label{fig:etage}}
...
% \begin{sloppypar}
  Il est surprenant de constater que ce bâtiment apparemment assez 
  extraordinaire ne figure guère dans les récits des esclaves, 
  ambassadeurs ou religieux qui ont décrit le Meknès du \siecle{17}. 
  Seul \gens[Joseph]{de Léon} semble le connaître. Selon lui, les 
  concubines tombées en disgrâce du sultan étaient reléguées dans ce 
  palais périphérique. En fait, ce bâtiment n'aurait peut-être été 
...
% % \begin{figure}[htb]
% \begin{figure}[p]
%   % \includegraphics[height=8cm]{palais_etage}
...
la grande cour centrale (\fref{fig:etage}). Ce sont des pièces de 
céramique glaçurée de forme parallélépipédique. Chacune comporte une 
glaçure monochrome. L'échantillon référencé \bdx{6528} présente une 
glaçure verte, le \bdx{6529}, une glaçure bleu-vert, le \bdx{6530}, 
une glaçure noire, le \bdx{6531}, une glaçure miel et le \bdx{6532}, 
...
\begin{tikzpicture}[
  ...
  \node at (current page.center) [shift={(0cm, 1cm)}]
        {\includegraphics[scale=2.97]{BDX_planche}} ;

  \node at (current page.north east) 
        [shift={(-5cm, -3.25cm)}, text width=7cm, align=center]
        {\Huge\bfseries\PaM\\Meknès -- Maroc\\\siecle{17}\par} ;
  \node at (current page.north west) 
        [shift={(5cm, -10.3cm)}, text width=5cm, align=center]
        {\Huge\bfseries Zelliges de pavement\par} ;

  \node at (current page.center) 
        [shift={(0.8cm, -2.6cm)}, text width=5cm, align=center]
        {\LARGE\bfseries \bdx{6530}} ;
  \node at (current page.center) 
        [shift={(-6.7cm, -2.6cm)}, text width=5cm, align=center]
        {\LARGE\bfseries \bdx{6528}} ;
  \node at (current page.center) 
        [shift={(7.2cm, -2.6cm)}, text width=5cm, align=center]
        {\LARGE\bfseries \bdx{6531}} ;
  \node at (current page.center) 
        [shift={(-5.4cm, -4.8cm)}, text width=5cm, align=center]
        {\LARGE\bfseries \bdx{6529}} ;
  \node at (current page.center) 
        [shift={(6cm, -4.9cm)}, text width=5cm, align=center]
        {\LARGE\bfseries \bdx{6532}} ;

  \node at (current page.south) 
        [shift={(0cm, 2cm)}, text width=\textwidth, align=center] {%
          \captionof{planche}
          % [Planche~1]
          {%
            Meknès (Maroc), \PaM, \siecle{17}. 
            Vues de la façade principale du Palais et du pavement 
            avant prélèvements (Clichés Haddad-Benmlih).
            Zelliges monochromes vert (\bdx{6528}), 
            bleu (\bdx{6529}), noir (\bdx{6530}), miel (\bdx{6531}) 
            et blanc (\bdx{6532}). (Montage C.~Ney) %
          }
          \label{pl:bdx_pam}
        } ;

  % \draw [red]
  %       (current page.center) -- ++ (-1.67cm, -4.cm) -- ++ (5cm, 0) ;
\end{tikzpicture}
% \end{figure}
...
\MEB (JEOL~850SM) et muni d'un détecteur semi-conducteur \ch{Si(Li)}.
...
\begin{figure}[htb]
  ...
  \begin{minipage}{0.39\textwidth}
    ...
    %   \lambda & longueur d'onde des \RX incidents\\
    %   \theta  & angle d'incidence des \RX par rapport à 
    %             la famille de plans réticulaires\\
...
(\fref{fig:DX}) \textsc{Siemens}~D500. La source de \RX est une 
